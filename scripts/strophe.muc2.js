...
Strophe.addConnectionPlugin('muc', {
	...
	init : function(conn) {
		...
		return Strophe.addNamespace('MUC_ROOMCONFIG', Strophe.NS.MUC + "#roomconfig");
	},

	statusChanged : function(status) {
		if (status === Strophe.Status.CONNECTED || status === Strophe.Status.ATTACHED) {
			this._connection.disco.addFeature(Strophe.NS.MUC);
			this._connection.disco.addFeature(Strophe.NS.MUC_USER);
			this._connection.disco.addFeature(Strophe.NS.MUC_OWNER);
			this._connection.disco.addFeature(Strophe.NS.MUC_ADMIN);
			this._connection.disco.addFeature(Strophe.NS.MUC_ROOMCONFIG);
		}
	},
	...
	join : function(room, nick, msg_handler_cb, pres_handler_cb, roster_cb, password) {
		var msg, room_nick, _base, _ref, _ref1, _this = this;
...
XmppRoom = (function() {
	...
	XmppRoom._parsePresence = function(pres) {
		...
		data.type = (( _ref = a.type) != null ? _ref.textContent :
		void 0) || null;
		data.states = [];
		...
		for ( _i = 0, _len = _ref1.length; _i < _len; _i++) {
			...
			switch (c.nodeName) {
				...
				case "x":
					a = c.attributes;
					if ((( _ref2 = a.xmlns) != null ? _ref2.textContent :
					void 0) === Strophe.NS.MUC_USER) {
						_ref3 = c.childNodes;
						for ( _j = 0, _len1 = _ref3.length; _j < _len1; _j++) {
							...
							switch (c2.nodeName) {
								case "item":
									a = c2.attributes;
									data.affiliation = (( _ref4 = a.affiliation) != null ? _ref4.textContent :
									void 0) || null;
									data.role = (( _ref5 = a.role) != null ? _ref5.textContent :
									void 0) || null;
									data.jid = (( _ref6 = a.jid) != null ? _ref6.textContent :
									void 0) || null;
									data.newnick = (( _ref7 = a.nick) != null ? _ref7.textContent :
									void 0) || null;
									break;
								case "status":
